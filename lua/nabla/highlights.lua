...
function M.setup()
    ...
    ------------------------------------------------------------------
    apply {
        String         = { fg = c.cyan.mint, fmt = cfg.code_style.strings },
        Character      = { fg = c.cyan.mint },
        Number         = { fg = c.orange.base },
        Float          = { fg = c.orange.base },
        Boolean        = { fg = c.orange.deep },
        Type           = { fg = c.green.lime },
        Structure      = { fg = c.purple.hot },
        StorageClass   = { fg = c.orange.warm, fmt = cfg.code_style.keywords },
        Identifier     = { fg = c.yellow.beach, fmt = cfg.code_style.variables },
        Constant       = { fg = c.orange.base },
        PreProc        = { fg = c.orange.warm },
        PreCondit      = { fg = c.orange.warm },
        Include        = { fg = c.green.light },
        Keyword        = { fg = c.orange.deep, fmt = cfg.code_style.keywords },
        Define         = { fg = c.orange.warm },
        Typedef        = { fg = c.purple.soft },
        Exception      = { fg = c.red.deep, fmt = cfg.code_style.keywords },
        Conditional    = { fg = c.yellow.warm, fmt = cfg.code_style.keywords },
        Repeat         = { fg = c.orange.base, fmt = cfg.code_style.keywords },
        Statement      = { fg = c.orange.deep, fmt = cfg.code_style.keywords },
        Macro          = { fg = c.blue.soft, fmt = cfg.code_style.functions },
        Error          = { fg = c.red.base },
        Label          = { fg = c.red.light },
    ...
    apply {
        ...
        --["@variable"]                       = { fg = c.cyan.pale_mint, fmt = cfg.code_style.variables },
        ["@variable"]                       = { fg = c.cyan.pale, fmt = cfg.code_style.variables },
        ["@variable.builtin"]               = { fg = c.yellow.beach, fmt = cfg.code_style.variables },
        ["@variable.parameter"]             = { fg = c.blue.light },
        ["@variable.parameter.builtin"]     = { fg = c.fg.base },  -- falls through to @variable.parameter
        ["@variable.member"]                = { fg = c.green.olive },
        ["@variable.global"]                = { fg = c.red.light },

        -- Constants
        ["@constant"]                       = { fg = c.yellow.cream },
        ["@constant.builtin"]               = { fg = c.orange.deep },
        ["@constant.macro"]                 = { fg = c.orange.deep },

        -- Strings / characters
        ["@string"]                         = { fg = c.cyan.mint, fmt = cfg.code_style.strings },
        -- ["@string.documentation"]           = { fg = c.fg.base },  -- falls through to @string
        ...
        -- ["@string.special.symbol"]          = { fg = c.fg.base },  -- falls through to @string.special
        -- ["@string.special.url"]             = { fg = c.fg.base },  -- falls through to @string.special
        -- ["@string.special.path"]            = { fg = c.fg.base },  -- falls through to @string.special
        ["@character"]                      = { fg = c.cyan.mint },
        ["@character.special"]              = { fg = c.cyan.base },

        -- Numbers / booleans
        ["@number"]                         = { fg = c.orange.deep },
        ["@number.float"]                   = { fg = c.orange.deep },
        ...
        ["@keyword.exception"]              = { fg = c.red.deep, fmt = cfg.code_style.keywords },
        ["@keyword.modifier"]               = { fg = c.purple.neon, fmt = cfg.code_style.keywords },
        ["@keyword.coroutine"]              = { fg = c.red.light, fmt = cfg.code_style.keywords },
        ["@keyword.type"]                   = { fg = c.cyan.teal, fmt = cfg.code_style.keywords },
        -- ["@keyword.debug"]                  = { fg = c.fg.base },  -- falls through to @keyword
        ["@keyword.directive"]              = { fg = c.green.leaf },  -- falls through to @keyword
        ["@keyword.directive.define"]       = { fg = c.green.fern },  -- falls through to @keyword.directive
        -- ["@keyword.export"]                 = { fg = c.fg.base },  -- falls through to @keyword

        -- Types
        ["@type"]                           = { fg = c.green.lime },
        ["@type.builtin"]                   = { fg = c.green.lime },
        -- ["@type.definition"]                = { fg = c.fg.base },  -- falls through to @type
        ["@type.qualifier"]                 = { fg = c.orange.deep, fmt = cfg.code_style.keywords },
        ["@attribute"]                      = { fg = c.cyan.base },
        -- ["@attribute.builtin"]              = { fg = c.fg.base },  -- falls through to @attribute
        ["@property"]                       = { fg = c.green.sage },
        ["@field"]                          = { fg = c.green.jade },

        -- Operators / punctuation
        ["@operator"]                       = { fg = c.blue.soft },
        ["@punctuation"]                    = { fg = c.fg.base },
        ["@punctuation.delimiter"]          = { fg = c.fg.muted },
        ["@punctuation.bracket"]            = { fg = c.cyan.base },
        ["@punctuation.special"]            = { fg = c.cyan.pale },

        -- Comments
        ["@comment"]                        = { fg = c.fg.muted, fmt = cfg.code_style.comments },
        -- ["@comment.documentation"]          = { fg = c.fg.base },  -- falls through to @comment
        ...
        -- Tags (HTML/JSX/etc.)
        ["@tag"]                            = { fg = c.blue.soft },
        -- ["@tag.builtin"]                    = { fg = c.fg.base },  -- falls through to @tag
        ["@tag.attribute"]                  = { fg = c.green.olive },
        ["@tag.delimiter"]                  = { fg = c.fg.muted },

        -- Markup (Markdown, doc strings)
        ["@markup"]                         = { fg = c.fg.base },
        -- ["@markup.heading"]                 = { fg = c.fg.base },  -- falls through to @markup
        ...
        -- ["@markup.environment.name"]        = { fg = c.fg.base },  -- falls through to @markup.environment
        ...
        -- ["@module.builtin"]                 = { fg = c.fg.base },  -- falls through to @module
    ...
    ------------------------------------------------------------------
    apply {
        -- Standard LSP semantic token types (spec)
        ["@lsp.type.namespace"]                    = { fg = c.green.leaf },
        ["@lsp.type.type"]                         = { fg = c.green.lime },
        ["@lsp.type.class"]                        = { fg = c.green.base },
        ["@lsp.type.enum"]                         = { fg = c.green.neon },
        ["@lsp.type.interface"]                    = { fg = c.green.base },
        ["@lsp.type.struct"]                       = { fg = c.purple.hot },
        ["@lsp.type.typeParameter"]                = { fg = c.green.deep },
        ["@lsp.type.parameter"]                    = { fg = c.blue.light },
        ["@lsp.type.variable"]                     = { fg = c.yellow.ceam, fmt = cfg.code_style.variables },
        ["@lsp.type.property"]                     = { fg = c.green.jade },
        ["@lsp.type.enumMember"]                   = { fg = c.orange.base },
        ["@lsp.type.event"]                        = { fg = c.fg.base },
        ["@lsp.type.function"]                     = { fg = c.blue.pure, fmt = cfg.code_style.functions },
        ["@lsp.type.method"]                       = { fg = c.blue.azure, fmt = cfg.code_style.functions },
        ["@lsp.type.macro"]                        = { fg = c.yellow.light, fmt = cfg.code_style.functions },
        ["@lsp.type.keyword"]                      = { fg = c.orange.deep, fmt = cfg.code_style.keywords },
        ["@lsp.type.modifier"]                     = { fg = c.orange.warm, fmt = cfg.code_style.keywords },
        ...
        ["@lsp.type.jperator"]                     = { fg = c.yellow.sand },
        ["@lsp.type.decorator"]                    = { fg = c.purple.deep },

        -- Server extensions (rust-analyzer / clangd / others)
        ["@lsp.type.builtinType"]                  = { fg = c.green.lime },
        ["@lsp.type.selfKeyword"]                  = { fg = c.orange.deep, fmt = cfg.code_style.variables },
        ["@lsp.type.selfTypeKeyword"]              = { fg = c.green.lime },
        ["@lsp.type.boolean"]                      = { fg = c.fg.base },
        ["@lsp.type.character"]                    = { fg = c.fg.base },
        ["@lsp.type.label"]                        = { fg = c.fg.base },
        ["@lsp.type.lifetime"]                     = { fg = c.fg.base },
        ["@lsp.type.generic"]                      = { fg = c.fg.base },
        ["@lsp.type.escapeSequence"]               = { fg = c.fg.base },
        ["@lsp.type.formatSpecifier"]              = { fg = c.fg.base },
        ["@lsp.type.builtinAttribute"]             = { fg = c.fg.base },
        ["@lsp.type.derive"]                       = { fg = c.fg.base },
        ["@lsp.type.attributeBracket"]             = { fg = c.fg.base },

        -- Type modifiers (applied additively over the base @lsp.type.*)
        ["@lsp.typemod.function.defaultLibrary"]   = { fg = c.blue.dodger, fmt = cfg.code_style.functions },
        ...
        ["@lsp.typemod.variable.readonly"]         = { fg = c.yellow.dune, fmt = cfg.code_style.variables },
        ["@lsp.typemod.variable.static"]           = { fg = c.yellow.clay, fmt = cfg.code_style.variables },
        ["@lsp.typemod.property.readonly"]         = { fg = c.orange.base },
        ["@lsp.typemod.keyword.async"]             = { fg = c.red.light, fmt = cfg.code_style.keywords },
        ...
        -- Unassigned typemods fall through to their base @lsp.type.* automatically.
        -- Uncomment to give a modifier its own style (e.g. italicize deprecated, bold declarations).
        -- ["@lsp.typemod.class.defaultLibrary"]      = { fg = c.fg.base },
        -- ["@lsp.typemod.struct.defaultLibrary"]     = { fg = c.fg.base },
        -- ["@lsp.typemod.enum.defaultLibrary"]       = { fg = c.fg.base },
        -- ["@lsp.typemod.interface.defaultLibrary"]  = { fg = c.fg.base },
        -- ["@lsp.typemod.type.defaultLibrary"]       = { fg = c.fg.base },
        -- ["@lsp.typemod.typeAlias.defaultLibrary"]  = { fg = c.fg.base },
        -- ["@lsp.typemod.macro.defaultLibrary"]      = { fg = c.fg.base },
        -- ["@lsp.typemod.function.declaration"]      = { fg = c.fg.base },
        -- ["@lsp.typemod.function.definition"]       = { fg = c.fg.base },
        -- ["@lsp.typemod.function.async"]            = { fg = c.fg.base },
        -- ["@lsp.typemod.function.deprecated"]       = { fg = c.fg.base, fmt = "strikethrough" },
        -- ["@lsp.typemod.function.documentation"]    = { fg = c.fg.base },
        -- ["@lsp.typemod.method.declaration"]        = { fg = c.fg.base },
        -- ["@lsp.typemod.method.async"]              = { fg = c.fg.base },
        -- ["@lsp.typemod.method.deprecated"]         = { fg = c.fg.base, fmt = "strikethrough" },
        -- ["@lsp.typemod.variable.declaration"]      = { fg = c.fg.base },
        -- ["@lsp.typemod.variable.deprecated"]       = { fg = c.fg.base, fmt = "strikethrough" },
        -- ["@lsp.typemod.variable.documentation"]    = { fg = c.fg.base },
        -- ["@lsp.typemod.variable.mutable"]          = { fg = c.fg.base },
        -- ["@lsp.typemod.variable.callable"]         = { fg = c.fg.base },
        -- ["@lsp.typemod.parameter.readonly"]        = { fg = c.fg.base },
        -- ["@lsp.typemod.parameter.declaration"]     = { fg = c.fg.base },
        -- ["@lsp.typemod.parameter.mutable"]         = { fg = c.fg.base },
        -- ["@lsp.typemod.type.declaration"]          = { fg = c.fg.base },
        -- ["@lsp.typemod.property.static"]           = { fg = c.fg.base },
        -- ["@lsp.typemod.selfKeyword.mutable"]       = { fg = c.fg.base },
        -- ["@lsp.typemod.comment.documentation"]     = { fg = c.fg.base },
        -- ["@lsp.typemod.string.documentation"]      = { fg = c.fg.base },
        -- ["@lsp.typemod.enumMember.static"]         = { fg = c.fg.base },
        -- ["@lsp.typemod.enumMember.declaration"]    = { fg = c.fg.base },
    }
