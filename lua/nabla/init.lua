...
function M.setup(opts)
    ...
    if vim.g.nabla_config.toggle_style_key then
      vim.api.nvim_set_keymap('n', vim.g.nabla_config.toggle_style_key, '<cmd>lua require("nabla").toggle()<cr>', { noremap = true, silent = true })
    end
end
